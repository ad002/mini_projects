...
#Assing some empty lists to store the input, have to be stored globally
adjectives = []
verbs=[]
nouns=[]
...
def getInput():
    ...
    adjectives.append(input("Please enter some adjectives: \n > "))
    verbs.append(input("Please enter some verbs: \n > "))
    nouns.append(input("Please enter some nouns: \n > "))
...
def generateSentence(adjectives, verbs, nouns):
...
def main():
    ...
    #generateSentence(adjectives,verbs,nouns)
    experiment()
